class AppTexts {
  static final Map<String, Map<String, String>> _texts = {
    'no': {
      ...
      'players': 'spillere',
      'player': 'spiller',
      'statisticsEmpty': 'Statistikk er tilgjengelig i Pro',
      ...
      'language': 'Språk',
      'aboutApp': 'Om appen',
      'versionText': 'Versjon 1.0 (utvikling)',
      'aboutDescription': 'En enkel digital poengblokk for Yatzy og Maxi Yatzy.',
      'norwegian': 'Norsk',
      'english': 'English',
      'rules': 'Regler',
      ...
      'ruleInfoTitle': 'Regel',
      'proVersion': 'Pro-versjon',
      'removeAds': 'Fjern reklame',
      'unlockStatistics': 'Lås opp statistikk',
      'proDescription': 'Pro gir deg en reklamefri opplevelse og full tilgang til statistikk.',
      'proActivated': 'Pro er aktivert',
      'activateProDemo': 'Aktiver Pro (demo)',
      'proActive': 'Pro er aktiv',
      'getPro': 'Oppgrader til Pro',
    },
    'en': {
      'appTitle': 'Yatzy Scorecard',
      ...
      'players': 'players',
      'player': 'player',
      'statisticsEmpty': 'Statistics are available in Pro',
      ...
      'versionText': 'Version 1.0 (development)',
      'aboutDescription': 'A simple digital scorecard for Yatzy and Maxi Yatzy.',
      'norwegian': 'Norwegian',
      'english': 'English',
      'rules': 'Rules',
      ...
      'proDescription': 'Pro gives you an ad-free experience and full access to statistics.',
      'proActivated': 'Pro has been activated',
